...
import * as import3 from './notification.component';
import * as import4 from '@angular/core/src/linker/view_utils';
import * as import5 from '@angular/core/src/di/injector';
import * as import6 from '@angular/core/src/linker/view_type';
import * as import7 from '@angular/core/src/change_detection/change_detection';
import * as import8 from './notification.service';
...
var renderType_NotificationComponent_Host:import0.RenderComponentType = (null as any);
class _View_NotificationComponent_Host0 extends import1.AppView<any> {
  _el_0:any;
  /*private*/ _appEl_0:import2.AppElement;
  _NotificationComponent_0_4:import3.NotificationComponent;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
    super(_View_NotificationComponent_Host0,renderType_NotificationComponent_Host,import6.ViewType.HOST,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    this._el_0 = this.selectOrCreateHostElement('app-notification',rootSelector,(null as any));
    this._appEl_0 = new import2.AppElement(0,(null as any),this,this._el_0);
    var compView_0:any = viewFactory_NotificationComponent0(this.viewUtils,this.injector(0),this._appEl_0);
    this._NotificationComponent_0_4 = new import3.NotificationComponent(this.parentInjector.get(import8.NotificationService));
    this._appEl_0.initComponent(this._NotificationComponent_0_4,[],compView_0);
    compView_0.create(this._NotificationComponent_0_4,this.projectableNodes,(null as any));
    this.init([].concat([this._el_0]),[this._el_0],[],[]);
    return this._appEl_0;
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import3.NotificationComponent) && (0 === requestNodeIndex))) { return this._NotificationComponent_0_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    if (((this.numberOfChecks === 0) && !throwOnChange)) { this._NotificationComponent_0_4.ngOnInit(); }
    this.detectContentChildrenChanges(throwOnChange);
    this.detectViewChildrenChanges(throwOnChange);
  }
}
function viewFactory_NotificationComponent_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_NotificationComponent_Host === (null as any))) { (renderType_NotificationComponent_Host = viewUtils.createRenderComponentType('',0,import9.ViewEncapsulation.None,[],{})); }
  return new _View_NotificationComponent_Host0(viewUtils,parentInjector,declarationEl);
}
export const NotificationComponentNgFactory:import10.ComponentFactory<import3.NotificationComponent> = new import10.ComponentFactory<import3.NotificationComponent>('app-notification',viewFactory_NotificationComponent_Host0,import3.NotificationComponent);
const styles_NotificationComponent:any[] = ['.backdrop[_ngcontent-%COMP%] {\n            background-color: rgba(0, 0, 0, 0.6);\n            position: fixed;\n            top: 0;\n            left: 0;\n            width: 100%;\n            height: 100vh;\n        }'];
var renderType_NotificationComponent:import0.RenderComponentType = (null as any);
class _View_NotificationComponent0 extends import1.AppView<import3.NotificationComponent> {
  _el_0:any;
  ...
  /*private*/ _expr_3:any;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
    super(_View_NotificationComponent0,renderType_NotificationComponent,import6.ViewType.COMPONENT,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._text_15 = this.renderer.createText(this._el_14,'Success!',(null as any));
    ...
    this.renderer.setElementAttribute(this._el_26,'class','btn btn-success');
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    this.detectContentChildrenChanges(throwOnChange);
    const currVal_3:any = import4.interpolate(1,'',((this.context.error == (null as any))? (null as any): this.context.error.message),'');
...
export function viewFactory_NotificationComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.NotificationComponent> {
  if ((renderType_NotificationComponent === (null as any))) { (renderType_NotificationComponent = viewUtils.createRenderComponentType('/Users/prasadsawant/Sites/fintech_mean/frontend/app/notification/notification.component.html',0,import9.ViewEncapsulation.Emulated,styles_NotificationComponent,{})); }
